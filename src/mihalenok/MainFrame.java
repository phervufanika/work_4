...
public class MainFrame extends JFrame {
    ...
    private JCheckBoxMenuItem ShowCriticalValuesMenuItem;
    ...
    public MainFrame() {
        ...
        ShowCriticalValuesMenuItem = new JCheckBoxMenuItem(showAxisAction);
        graphicsMenu.add(ShowCriticalValuesMenuItem);
        ShowCriticalValuesMenuItem.setSelected(true);
        Action showCriticalValues = new AbstractAction("Show critical Values") {
            public void actionPerformed(ActionEvent event) {
                display.ShowCriticalValues(ShowCriticalValuesMenuItem.isSelected());
            }
        };
        ShowCriticalValuesMenuItem = new JCheckBoxMenuItem(showCriticalValues);
        graphicsMenu.add(ShowCriticalValuesMenuItem);
        ShowCriticalValuesMenuItem.setEnabled(false);
    ...
    protected void openGraphics(File selectedFile) {
        ...
        ShowCriticalValuesMenuItem.setEnabled(true);
    ...
    private class GraphicsMenuListener implements MenuListener {
        public void menuSelected(MenuEvent e) {
            ...
            ShowCriticalValuesMenuItem.setEnabled(fileLoaded);
